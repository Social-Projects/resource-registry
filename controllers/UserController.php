...
class UserController extends AppController 
{
    ...
    public function actionUserdata() {
        ...
        if($request['userId']) {
            $getdata = User::find()
            ->select(['user_id','username','last_name','first_name','email','middle_name','passport_series','passport_number','address','role.name as role_name','community.name as community_name','user.community_id as communityId','activation_status'])
